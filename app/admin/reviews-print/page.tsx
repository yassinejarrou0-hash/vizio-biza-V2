...
const SCHEMA: Record<keyof Review, FieldType> = {
  ...
  detail: { kind: "text", label: "Poste / Entreprise / Contexte" },
  avatar: { kind: "text", label: "Initiales (2 caractères)", placeholder: "KA" },
  ...
  return (
    <>
      <div className="admin-page-head">
        <h1>Avis · Impression</h1>
        <span className="crumb">
          <Link href="/admin">Admin</Link> / Avis Impression
        </span>
      </div>
      <div className="admin-card">
        <p>
          Modifiez les avis clients affichés sur la page <Link href="/impression#avis" target="_blank">Impression</Link>.
        </p>
      </div>
      <AdminEditor<Review[]>
        section="reviews-print"
        initial={site.print.reviews}
        schema={SCHEMA}
        isList
        newItem={NEW_REVIEW}
